...
- **Endpoint GET**: `GET /api/orders/{orderId}`
  - **Propósito**: Buscar detalhes do pedido (itens, preços, cliente) para gerar o QR Code
  
- **Endpoint POST**: `POST /api/orders/{orderId}/confirm-payment`
...
10. Payment Service → Order Service: POST /api/orders/{orderId}/confirm-payment
